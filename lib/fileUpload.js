...
const ALLOWED_TYPES = ['image/jpeg', 'image/jpg', 'image/png', 'image/svg+xml', 'image/x-icon', 'image/vnd.microsoft.icon'];
...
export async function saveUploadedFile(file, category = 'general') {
  ...
  if (!ALLOWED_TYPES.includes(file.type)) {
    throw new Error(`Geçersiz dosya tipi. İzin verilenler: JPG, PNG, SVG, ICO`);
  }
